...
const CONFIG = {
  ...
  memories: [
    ...
    { type:"image", src:"assets/kay2.png",        title:"عملتلككك اضافرككك",                             date:"2024-03-08", description:"بس جددد كيف وانا ازبطهم ؟ اوك ما كانو احسن اشي للمصداقية بس يعني عملتهم Bحب والله" },
    { type:"image", src:"assets/44.jpg",          title:"يوم ما يوسف قعد يترجاني ارجع عشان انقذه من سما", date:"2024-04-04", description:"فكرته يوم حلو , بس طلع كئيب , جد كنت كلب فيه , بس בغض النظر للامانة فرطت ضحك على يوسف بعد ما اكل المقلب ابن الكلب اللي عملناه فيه" },
    { type:"image", src:"assets/impossible.jpg",  title:"اليوم اللي تاكدت فيه انو مستحيل ارجع اشوفك",   date:"2024-05-09", description:"كنا بنفس الشارع بنفس المكان , بنفس الطريق , بنفس التوقيت , بنفس اليوم والتاريخ , ومع هيك عشان سبب تافه , ضاعت فرصة اني اشوفك بعد مليون محاولة , للامانة جد نكدت , бس يعني يلا عادي , خليها للسنين الجاي" },
    { type:"image", src:"assets/seen.jpg",        title:"seen",                                           date:"2024-05-16", description:"هاي لقيتها بالغلط عندي , انداري متى كانت , бس أكيد كانت وحدة من فتراتنا الخرا ، السين جدا سيء ومؤلم و أسف لو حسستك بهاد الشعور في اليوم من الايام ، جربته وطلع عاطل عنجد, أسف" },
    { type:"video", src:"assets/seconed.mp4",     title:"اول فيديو باول طلعة النا🎬",                     date:"2024-02-1", description:"بتذكره كان يوم בارد ، бس مش בردان ، متحمس ، متدفي ، бس كنت Bدي Bشوف شو هالاشي الرهيب اللي Bخلينи Bدي Bياكي باستماتة ، وبعد ما شفتك دايركت عرفته ، شعور انه -اوه هاد هو الشخص- يب ، Bنتي الشخص الصح ، والوقت صح وكلشي كان صح ， ما Bحلاكي ， Jd ما Bحلاكي ， وما Bحلانا_." },
