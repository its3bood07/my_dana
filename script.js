...
const CONFIG = {
  ...
  memories: [
    ...
    { type:"image", src:"images/44.jpg",          title:"يوم ما يوسف قعد يترجاني ارجع عشان انقذه من سما", date:"2024-04-04", description:"فكرته يوم حلو , بس طلع كئيب , جد كنت كلب فيه , בס בغض النظر للامانة فرطت ضحك على يوسف بعد ما اكل المقلب ابن الكلب اللي عملناه فيه" },
    { type:"image", src:"images/impossible.jpg",  title:"اليوم اللي تاكدت فيه انو مستحيل ارجع اشوفك",   date:"2024-05-09", description:"كنا بنفس الشارع بنفس المكان , بنفس الطريق , بنفس التوقيت , بنفس اليوم والتاريخ , ومع هيك عشان سبب تافه , ضاعت فرصة اني اشوفك بعد مليون محاولة , للامانة جد نكدت , бس يعني يلا عادي , خليها للسنين الجاي" },
    { type:"image", src:"images/seen.jpg",        title:"seen",                                           date:"2024-05-16", description:"هاي لقيتها بالغلط عندي , انداري متى كانت , бس أكيد كانت وحدة من فتراتنا الخرا ، السين جدا سيء ومؤلم و أسف لو حسستك بهاد الشعور في اليوم من الايام ، جربته وطلع عاطل عنجد, أسف" },
    { type:"video", src:"images/seconed.mp4",     title":"اول فيديو باول طلعة النا🎬",                     date:"2024-02-1", description:"بتذكره كان يوم בارد ، бס مش בردان ، מتحمس ، מتدفي ، בס كنت Bדי Bشوف شו هالاشי الرהيب اللي Bخلينי Bדי Bياكي باستماتة ، وبعد ما شفتك دايركت עرفته ， شعور انه -اوه هاد هو الشخص- יב ， Bנטי الشخص الصح ， והوقت صح וכלشي היה صح ， ما Bחלאקי ， Jd ما Bחלאקי ， وما Bحلانا_." },
  ...
  playlist: [
    ...
    { name:"Glimpse of Us",         artist:"Joji",                 meaning:"أنتِ حكيتِ إنك صرتِ تسمعيها",                      file:"songs/Glimpse_of_Us.mp3",            cover:"assets/cover6.JPG"  },
    { name:"Die for You",           artist:"Joji / TUYO / Mora",   meaning:"جوجي مبدع بتوصيل الإحساس",                         file:"songs/Die_for_You.mp3",                cover:"assets/cover7.JPG"  },
