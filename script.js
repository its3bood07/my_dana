...
const CONFIG = {
  ...
  memories: [
    ...
    { type:"image", src:"images/kay2.png",        title:"عملتلككك اضافرككك",                             date:"2024-03-08", description:"بس جددد كيف وانا ازبطهم ؟ اوك ما كانو احسن اشي للمصداقية بس يعني عملتهم بحب والله" },
    { type:"image", src:"images/44.jpg",          title:"يوم ما يوسف قعد يترجاني ارجع عشان انقذه من سما", date:"2024-04-04", description:"فكرته يوم حلو , بس طلع كئيب , جد كنت كلب فيه , بس بغض النظر للامانة فرطت ضحك على يوسف بعد ما اكل المقلب ابن الكلب اللي عملناه فيه" },
    { type:"image", src:"images/impossible.jpg",  title:"اليوم اللي تاكدت فيه انو مستحيل ارجع اشوفك",   date:"2024-05-09", description:"كنا بنفس الشارع بنفس المكان , بنفس الطريق , بنفس التوقيت , بنفس اليوم والتاريخ , ومع هيك عشان سبب تافه , ضاعت فرصة اني اشوفك بعد مليون محاولة , للامانة جد نكدت , بس يعني يلا عادي , خليها للسنين الجاي" },
    { type:"image", src:"images/seen.jpg",        title:"seen",                                           date:"2024-05-16", description:"هاي لقيتها بالغلط عندي , انداري متى كانت , بس اكيد كانت وحدة من فتراتنا الخرا , السين جدا سيء ومؤلم و اسف لو حسستك بهاد الشعور في اليوم من الايام , جربته وطلع عاطل عنجد, اسف" },
    { type:"video", src:"images/seconed.mp4",     title:"اول فيديو باول طلعة النا🎬",                     date:"2024-02-1", description:"بتذكره كان يوم بارد , بس مش بردان , متحمس , متدفي , بس كنت بدي اشوف شو هالاشي الرهيب اللي بخليني بدي اياكي باستماتة , وبعد ما شفتك دايركت عرفته , شعور انه -اوه هاد هو الشخص- يب , انتي الشخص الصح , والوقت صح وكلشي كان صح , ما احلاكي , جد ما احلاكي , وما احلانا_." },
  ...
  playlist: [
    { name:"Heather",               artist:"Conan Gray",           meaning:"كل ما اسمعها بتذكر لما طلبتي مني الجاكيت , وانا زي الغبي ما كنت اعرف",         file:"songs/Heather.mp3",                  cover:"images/cover1.jpg"  },
    { name:"Meen ysadak",           artist:"الضبع",                meaning:"أغنية الفيلم اللي حكيتيلي احضره ولسا ما حضرته",    file:"songs/Meen ysadak.mp3",              cover:"images/cover2.PNG"  },
    { name:"Apocalypse",            artist:"Cigarettes After Sex", meaning:"الأغنية اللي بترجعني لأحلى لحظة باللويبدة",        file:"songs/Apocalypse.mp3",               cover:"images/cover3.PNG"  },
    { name:"Romantic Homicide",     artist:"d4vd",                 meaning:"كنت بدي أنساكِ بس ما زبطت معي",                    file:"songs/Romantic Homicide.mp3",        cover:"images/cover4.jpg"  },
    { name:"We Fell in Love in October", artist:"girl in red",     meaning:"هاي بتذكرني فيكِ الصراحة",                          file:"songs/we fell in love in october.mp3", cover:"images/cover5.jpg" },
    { name:"Glimpse of Us",         artist:"Joji",                 meaning:"أنتِ حكيتِ إنك صرتِ تسمعيها",                      file:"songs/Glimpse of Us.mp3",            cover:"images/cover6.jpg"  },
    { name:"Die for You",           artist:"Joji / TUYO / Mora",   meaning:"جوجي مبدع بتوصيل الإحساس",                         file:"songs/Die for U.mp3",                cover:"images/cover7.jpg"  },
    { name:"Her",                   artist:"JVKE",                 meaning:"كانت تشتغل لحالها براسي كل ما أشوفكِ",             file:"songs/her.mp3",                      cover:"images/cover8.JPEG" },
    { name:"Sunsetz",               artist:"Cigarettes After Sex", meaning:"بعرفش ليش حطتها بس ليش لا",                       file:"songs/Sunsetz.mp3",                  cover:"images/cover9.JPEG" },
    { name:"Atnasyna",              artist:"—",                    meaning:"كنتِ مرة مصورة فيديو عليها وكنتِ كثير حلوة",       file:"songs/atnasyna.mp3",                 cover:"images/cover10.jpg" },
    { name:"Shem el yasmeen",       artist:"مشروع ليلى",           meaning:"هيك صرت أحس بعد ما تقبلت إن كل شيء بيننا مستحيل", file:"songs/shem el yasmeen.mp3",          cover:"images/cover11.JPEG"},
    { name:"The night we met",      artist:"Lord Huron", meaning:"لما طلعنا طلعة بيسترو , هاي اللي كانت براسي لما روحتي وانا بتطلع عليكي", file:"songs/the night we met.mp3", cover:"images/five.jpg" },
    { name:"ma to7shneesh",         artist:"امير عيد", meaning:"امنية مستحيل تتحقق للامانة ", file:"songs/mato7shneesh.mp3", cover:"images/kay3.jpeg" },
